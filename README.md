...
Tinder 式滑动整理系统相册的 Flutter 应用。在设备本地完成整理、清理与足迹解析，不上传照片。

**当前版本：v1.1.0** · iOS · Android（API 29+）
...
<table>
  <tr>
    <td align="center"><img src="assets/screenshots/library.png" width="200" alt="相库"/><br/><sub><b>相库</b><br/>选择来源 / 目标，滑动整理</sub></td>
    <td align="center"><img src="assets/screenshots/smart.png" width="200" alt="智能"/><br/><sub><b>智能</b><br/>截图清理 · 相似图 · 大视频</sub></td>
    <td align="center"><img src="assets/screenshots/footprints.png" width="200" alt="足迹"/><br/><sub><b>足迹</b><br/>GPS 地图 · 城市列表 · 海报</sub></td>
    <td align="center"><img src="assets/screenshots/profile.png" width="200" alt="我的"/><br/><sub><b>我的</b><br/>主题 · 地图样式 · 设置</sub></td>
  </tr>
</table>

> 截图文件放在 `assets/screenshots/`，命名见 [`assets/screenshots/README.md`](assets/screenshots/README.md)。
...
| iOS | Xcode + CocoaPods（`IPHONEOS_DEPLOYMENT_TARGET = 13.0`） |
| Android | Android SDK + JDK 17（`minSdk = 29`） |
...
首次运行需授予相册权限。Android 13+ 支持部分照片访问；Android 10–12 为全量授权或拒绝。
...
版本号在 `pubspec.yaml` 中维护（如 `1.1.0+3`：前者为显示版本，后者为构建号）。
